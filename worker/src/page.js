...
.map-wrap::after { content:""; position:absolute; left:0; right:0; bottom:-56px; height:178px; z-index:500; pointer-events:none; background:linear-gradient(to bottom,rgba(237,245,233,0),rgba(237,245,233,.32) 32%,rgba(237,245,233,.78) 62%,rgba(237,245,233,.98) 100%); -webkit-backdrop-filter:blur(12px) saturate(1.08); backdrop-filter:blur(12px) saturate(1.08); mask-image:linear-gradient(to bottom,transparent,#000 18%,#000); -webkit-mask-image:linear-gradient(to bottom,transparent,#000 18%,#000); }
